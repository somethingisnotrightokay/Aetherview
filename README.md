 > **AetherView** is a free, self-hosted, cross-platform 3D wallpaper engine that turns your screen into a dynamic window into another world.  
...
- **Runs directly in the browser** (perfect for GitHub Pages hosting)

---

## 🧠 What Makes It Different

AetherView doesn’t fake 3D by moving objects — it shifts the camera projection itself using **off-axis rendering**, the same principle used in real-world head-tracked displays.

This creates the illusion of looking through an actual window, where foreground and background move differently as you shift your perspective.

---

## 🚀 Use Cases

- Turn your desktop into a **live 3D scene**
...
Most wallpaper engines simulate depth.

**AetherView recreates it.**